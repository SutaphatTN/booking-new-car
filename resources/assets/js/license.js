...
$(document).on('click', '.btnEditPlateStatus', function () {
  ...
  Swal.fire({
    ...
    text:
      'ทุกสถานะยกเว้น "ปกติ" จะยืมและเลือกใช้กับงานขายใหม่ไม่ได้ ' +
      '(ทดลองขับ = กันไว้ให้เลือกในหน้า Car Order) — ป้ายที่ยืมมาจากแบรนด์อื่นก็เปลี่ยนได้ ระบบเก็บประวัติไว้ทุกครั้ง',
    input: 'select',
