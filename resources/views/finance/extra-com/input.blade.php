      ...
      <div class="modal-header mf-header mf-header--input px-4">
        <div class="d-flex align-items-center gap-3">
          <div class="mf-hd-icon">
            <i class="bx bx-plus-circle fs-5 text-white"></i>
          </div>
          <div>
            <h6 class="mb-0 fw-bold text-white mf-hd-title">เพิ่มข้อมูลไฟแนนซ์ Com Extra</h6>
            <small class="text-white mf-hd-sub">Add Finance Com Extra</small>
          </div>
        </div>
      ...
      <div class="modal-body mf-body">
        <form
          ...
          <div class="mf-section">
            ...
            <div class="mf-section-body">
              <div class="row g-3">
                ...
                <div class="col-12">
                  <label for="inp_ec_financeID" class="mf-label form-label">
                    <i class="bx bx-building-house"></i> ชื่อไฟแนนซ์ <span class="text-danger">*</span>
                  </label>
                  <select id="inp_ec_financeID" name="financeID"
                ...
                <div class="col-12">
                  <label for="inp_ec_model_id" class="mf-label form-label">
                    <i class="bx bx-car"></i> รุ่นรถหลัก <span class="text-danger">*</span>
                  </label>
                  <select id="inp_ec_model_id" name="model_id"
          ...
          <div class="mf-section">
            ...
            <div class="mf-section-body">
              <div class="row g-3">
                ...
                <div class="col-6">
                  <label for="inp_ec_com" class="mf-label form-label">
                    <i class="bx bx-badge-check ci-amber"></i> Com Extra <span class="text-danger">*</span>
                  </label>
                  <div class="input-group">
                    <span class="input-group-text ig-amber">฿</span>
                    <input id="inp_ec_com" type="text"
                      class="form-control text-end money-input @error('com') is-invalid @enderror"
                      name="com" placeholder="0.00" required>
                  </div>
                  @error('com')
          ...
          <div class="d-flex justify-content-end gap-2 pt-1">
            ...
            <button type="button" class="btn btn-primary px-5 btnStoreFinanceExtraCom">
