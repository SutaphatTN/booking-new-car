<div class="modal fade viewExportAccPart" tabindex="-1" role="dialog" data-bs-backdrop="static">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header border-bottom">
        <h4 class="modal-title mb-2" id="viewExportAccPartLabel">รายงานการใช้ประดับยนต์</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body text-sm">
        <form action="{{ route('accessory.accessory-partner-export') }}" method="GET" target="_blank">
