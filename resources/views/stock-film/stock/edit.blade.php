            ...
            <div class="mf-section-body">
              <div class="row g-2">
                ...
                <div class="col-md-6">
                  ...
                  <input id="ed_stock_no" type="text" class="form-control form-control-plaintext-mf fw-bold text-primary"
                ...
                <div class="col-md-4">
                  ...
                  <input id="ed_used_qty" type="text" class="form-control form-control-plaintext-mf text-end text-danger fw-bold"
                ...
                <div class="col-md-6">
                  ...
                  <input id="ed_part_no" type="text" name="part_no" class="form-control"
                    value="{{ $stock->part_no }}" placeholder="ระบุ Part No. (ถ้ามี)">
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <input id="ed_initial_qty" type="number" name="initial_qty" class="form-control text-end"
                    value="{{ $stock->initial_qty }}" min="0" step="0.01" required>
                </div>

                <div class="col-md-12">
                  <label for="ed_remaining_qty" class="mf-label form-label">คงเหลือ (ตร.ฟุต)</label>
                  <input id="ed_remaining_qty" type="text" class="form-control form-control-plaintext-mf text-end text-success fw-bold"
              ...
              <div class="row g-3">
                ...
                <div class="col-md-12">
                  ...
                  <select id="ed_inspection_result" name="inspection_result" class="form-select">
                    ...
                    <option value="pass" {{ $stock->inspection_result === 'pass' ? 'selected' : '' }}>ถูกต้อง</option>
                    <option value="fail" {{ $stock->inspection_result === 'fail' ? 'selected' : '' }}>ไม่ถูกต้อง</option>
                  </select>
                </div>
