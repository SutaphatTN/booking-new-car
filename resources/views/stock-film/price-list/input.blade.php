        ...
        <form id="formInputFilmPrice">
          ...
          <div class="mf-section mb-3">
            ...
            <div class="mf-section-body">
              <div class="row g-3">
                ...
                <div id="fp_door_rear2_fields" class="col-6 col-md-3 d-none">
                ...
                <div id="fp_sunroof_fields" class="col-6 col-md-3 d-none">
                ...
                <div id="fp_3window_fields" class="col-6 col-md-3 d-none">
          ...
          <div class="mf-section mb-3">
            <div class="mf-section-hd flex-wrap">
              ...
              <button type="button" class="btn btn-sm btn-outline-primary ms-auto text-nowrap btnAddBrandRow">
