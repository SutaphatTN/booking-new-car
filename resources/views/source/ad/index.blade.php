              ...
              <div class="mf-section-body">
                <div class="row g-3">
                  ...
                  <div class="col-12">
                    ...
                    <input id="ad_name" type="text" class="form-control" name="name" placeholder="ชื่อคลิป/แอด..."
                  ...
                  <div class="col-12">
                    ...
                    <input id="ad_url" type="text" class="form-control" name="url" placeholder="https://..."
                      maxlength="2000">
                  </div>
  ...
  <script>
    (function() {
        ...
        $.ajax({
          ...
          error: function(xhr) {
            Swal.fire({
              icon: 'error',
              title: 'เกิดข้อผิดพลาด',
              text: xhr.responseJSON?.message || 'กรุณาติดต่อแอดมิน'
            });
          },
        });
      });
      ...
      $('.adTable tbody').on('click', '.btnArchiveAd', function() {
        toggleAd($(this).data('id'), '{{ url('marketing/ad') }}/' + $(this).data('id') + '/archive',
          'เก็บแอดนี้? จะไม่แสดงเป็นตัวเลือกในหน้าเพิ่มการติดตาม');
      });

      $('.adTable tbody').on('click', '.btnRestoreAd', function() {
        toggleAd($(this).data('id'), '{{ url('marketing/ad') }}/' + $(this).data('id') + '/restore',
          'นำแอดนี้กลับมาแสดงเป็นตัวเลือก?');
      });
    })();
  </script>
@endsection
