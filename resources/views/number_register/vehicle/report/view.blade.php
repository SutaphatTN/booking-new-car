<div class="modal fade viewExportVH" tabindex="-1" role="dialog" data-bs-backdrop="static">
    ...
    <div class="modal-content border-0 shadow mf-content mf-content--view">
      <div class="modal-header mf-header mf-header--view px-4">
        <div class="d-flex align-items-center gap-3">
          ...
          <div>
            <h6 class="mb-0 fw-bold text-white mf-hd-title">ป้ายทะเบียนส่งเบิก/เคลียร์</h6>
      ...
      <div class="modal-body mf-body">
        <form action="{{ route('vehicle.vehicle-export') }}" method="GET">
          <div class="row g-3">
            <div class="col-6">
