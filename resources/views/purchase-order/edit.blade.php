              ...
              <div class="col-md-12">
                <div class="row g-6">
                        ...
                        @if (auth()->user()->brand == 2)
                          <div class="col-md-2">
                            ...
                            <input type="date" class="form-control" name="danu_date"
                              value="{{ old('danu_date', $reservationPayment->danu_date ?? '') }}"
                              {{ $disabled }}>
                          </div>
                        @endif
                      </div>
                  ...
                  @if ($userRole !== 'sale')
                    ...
                    <input type="hidden" id="CarOrderID" name="CarOrderID"
                      value="{{ $saleCar->CarOrderID ?? '' }}">
                  ...
                  <div class="row g-2">
                    <div class="col-md-12">
                      <div class="finance-box">
                        ...
                        <div class="row align-items-center">
                          <label for="Note" class="col-12 col-md-2 mb-1 mb-md-0">
                            หมายเหตุ
                          </label>
