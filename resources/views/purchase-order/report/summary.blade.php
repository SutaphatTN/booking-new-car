    ...
    <div class="page-header">
      <div class="page-header-top">
        ...
        <div class="page-header-top-cell right">
          ...
          <span
            class="h-value">{{ $saleCar->format_delivery_date_sum ?? '-' }}&ensp;|&ensp;{{ $saleCar->provinces->name ?? '-' }}</span>
        </div>
      </div>
    </div>
            ...
            <div class="sec-body">
              ...
              @if ($saleCar->remainingPayment?->type === 'finance')
                ...
                <div class="f">
                  ...
                  <div class="fv">
                    {{ is_numeric($campaignBalance) ? number_format($campaignBalance, 2) . ' บาท' : '-' }}
                  </div>
                </div>
                <div class="f">
                ...
                <div class="f">
                  ...
                  <div class="fv">
                    {{ is_numeric($discountBalance) ? number_format($discountBalance, 2) . ' บาท' : '-' }}
                  </div>
                </div>
                <div class="f">
          ...
          <table>
            <thead>
              <tr>
                ...
                <th>รายละเอียด</th>
                <th style="width:75px">ราคา</th>
                <th style="width:55px">Com</th>
              </tr>
            </thead>
            <tbody>
