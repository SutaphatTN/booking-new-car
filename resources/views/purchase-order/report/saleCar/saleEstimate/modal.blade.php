{{-- ใช้ class .viewExportSaleCar เดิม เพื่อให้ JS (purchase-order.js) เปิด modal อัตโนมัติ --}}
    ...
    <div class="modal-content border-0 shadow mf-content mf-content--view">
      <div class="modal-header mf-header mf-header--view px-4">
        <div class="d-flex align-items-center gap-3">
          ...
          <div>
            <h6 class="mb-0 fw-bold text-white mf-hd-title">ประมาณการเซลล์</h6>
      ...
      <div class="modal-body mf-body">
        <form action="{{ route('purchase-order.saleEstimate-export') }}" method="GET">
          <div class="row g-3">
            <div class="col-12">
