<div class="modal fade viewExportInsurance" tabindex="-1" role="dialog" data-bs-backdrop="static">
    ...
    <div class="modal-content border-0 shadow mf-content mf-content--view">
      <div class="modal-header mf-header mf-header--view px-4">
        <div class="d-flex align-items-center gap-3">
          ...
          <div>
            <h6 class="mb-0 fw-bold text-white mf-hd-title">ข้อมูลประกันภัย</h6>
            <small class="text-white mf-hd-sub">เลือกเดือนที่ส่งมอบ (แยกตาม sheet ทุกยี่ห้อ)</small>
          </div>
        </div>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body mf-body">
        <form action="{{ route('purchase-order.insurance-export') }}" method="GET">
          <div class="row g-3">
            <div class="col-12">
