<div class="modal fade viewExportLeadOnline" tabindex="-1" role="dialog" data-bs-backdrop="static">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content border-0 shadow mf-content mf-content--view">
      ...
      <div class="modal-body mf-body">
        <form action="{{ route('purchase-order.lead-online-export') }}" method="GET">
          <div class="row g-3">
            <div class="col-12">
