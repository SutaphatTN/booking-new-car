          ...
          <div class="row">
            ...
            @else
              <div class="col-md-12 mb-5">
                ...
                <textarea id="reason" name="reason" class="form-control" disabled>{{ $order->reason ?? '-' }}</textarea>
              </div>
            @endif
            ...
            <div class="col-md-5 mb-5">
              ...
              <input id="model_id" class="form-control" type="text" value="{{ $order->model->Name_TH }}"
                disabled />
            </div>
