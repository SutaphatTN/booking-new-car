    ...
    <div class="modal-content border-0 shadow mf-content mf-content--edit">
      ...
      <div class="modal-body mf-body">
        <form id="approveWaitingForm" action="{{ route('car-order.updateApproveWaiting', $waiting->id) }}"
          ...
          @elseif (in_array(auth()->user()->role, ['admin', 'audit', 'audit_lead', 'audit_dp', 'gm', 'manager', 'md']))
            <div class="d-flex justify-content-end gap-2 pt-1">
              <button type="button" class="btn btn-secondary px-4" data-bs-dismiss="modal">
                <i class="bx bx-x me-1"></i>ปิด
              </button>
              <button type="button" class="btn btn-success px-5 btnAcknowledgeRejectWaiting" data-id="{{ $waiting->id }}">
