      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-3 mb-5">
            ...
            <input id="order_status" class="form-control" type="text" value="{{ $order->orderStatus->name }}"
              disabled />
          </div>
          ...
          @if ($order->purchase_type == 1)
            <div class="col-6">
              <div class="col-md-12 mb-5">
                ...
                <input type="text" class="form-control" value="{{ $order->cam_testdrive ?? '' }}" disabled>
              </div>
            </div>
            ...
            <div class="col-6">
              <div class="col-md-12 mb-5">
                ...
                <input type="text" class="form-control" value="{{ $order->mileage_test ?? '' }}" disabled>
              </div>
            </div>
          @endif
          ...
          <div class="col-md-3 mb-5">
            ...
            <input id="system_date" class="form-control" type="text" value="{{ $order->format_system_date }}"
              disabled />
          </div>
