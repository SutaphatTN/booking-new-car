  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form
          action="{{ route('campaign.update', $cam->id) }}"
          method="POST"
          ...
          <div class="row">
            <div class="col-md-6 mb-5">
              ...
              <select id="model_id" name="model_id" class="form-select @error('model_id') is-invalid @enderror" required>
                ...
                @foreach ($model as $m)
                <option value="{{ @$m->id }}" {{ $cam->model_id == $m->id ? 'selected' : '' }}>{{ @$m->Name_TH }}</option>
                @endforeach
              </select>
            ...
            <div class="col-md-6 mb-5">
              ...
              <input id="startDate" type="date"
                ...
                name="startDate" value="{{ $cam->startDate }}" required>
            ...
            <div class="col-md-6 mb-5">
              ...
              <input id="endDate" type="date"
                ...
                name="endDate" value="{{ $cam->endDate }}" required>
          ...
          <div class="d-flex justify-content-end gap-2">
            ...
            <button type="button" class="btn btn-primary btnUpdateCampaign">บันทึก</button>
          </div>
