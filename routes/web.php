...
//accessory partner
Route::get('accessory/view/partner', [AccessoryController::class, 'viewPartner']);
...
Route::resource('model-car', ModelCarController::class);
Route::resource('sub-model-car', SubModelCarController::class);
